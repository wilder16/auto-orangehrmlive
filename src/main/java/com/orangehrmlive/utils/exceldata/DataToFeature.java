package com.orangehrmlive.utils.exceldata;
...
public class DataToFeature {
     ...
     *
     * @param featureFile Nombre del archivo .feature el cual se modificaro, debe tener la ruta del archivo y la hoja ser usada
     * @return
...
//                String excelDataRange = null;
    ...
    /**
     * Lista de todos los features con sus respectivos archivo de excel que se usaran en la prueba
     *
     * @param folder Carpeta donde estaran los archivo .feature
     * @return
     **/
